...
/*   Updated: 2020/12/08 13:10:40 by ablane           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define USAGE_FLAG			"Usage: Use the flag (-dump, -d, -v) after the \"corvar\" (ex1:./corewar -dump 5 champion_name.cor, ex2:./corewar -v champion_name.cor)"
# define USAGE_FLAG_N		"Usage: Use the -n flag with a number from 1 to N (N is the number of players participating in this game) before the champion name (for example, 1: ./ corewar -n 3 champion-name.cor -n 2 champion-name 2.cor champion-name3 .cor)"
